...
for row in profiles:
    ...
    ib_high, ib_low, ib_range = ib_data[d]

    print(f"IB HIGH : {round(ib_high)}")
    print(f"IB LOW  : {round(ib_low)}")
    print(f"IB RANGE: {round(ib_range)}")
    if ib_range > 500:
        print("IB TYPE : WIDE")

    elif ib_range < 350:
        print("IB TYPE : NARROW")

    else:
        print("IB TYPE : NORMAL")
